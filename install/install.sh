...
render(){ sed -e "s/INSTANCE/$INSTANCE/g"   -e "s/Example University/${RIMS_INSTITUTION_NAME:-Example University}/g"   -e "s#SCOPUS_AFFILIATION_ID=#SCOPUS_AFFILIATION_ID=${SCOPUS_AFFILIATION_ID:-}#g"   -e "s#RIMS_PUBLIC_PROFILE_BASE_URL=#RIMS_PUBLIC_PROFILE_BASE_URL=${RIMS_PUBLIC_PROFILE_BASE_URL:-}#g"   -e "s/library@example.edu/${CROSSREF_MAILTO:-library@example.edu}/g" "$1"; }
