...
grep -RniE '(sk-[A-Za-z0-9_-]{20,}|AIza[0-9A-Za-z_-]{20,}|bearer[[:space:]]+[A-Za-z0-9._-]{20,})' \
  /usr/share/koha/bin/bu-*research* /usr/share/koha/opac/cgi-bin/opac/opac-researcher-* 2>/dev/null && {
